...
export const ClinicalAppLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <linearGradient id="caduceus_staff_grad" x1="50" y1="20" x2="50" y2="80" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#39ff14" />
        <stop offset="50%" stopColor="#0ea5e9" />
        <stop offset="100%" stopColor="#0284c7" />
      </linearGradient>
      <linearGradient id="wing_grad" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="0%" stopColor="#39ff14" stopOpacity="0" />
        <stop offset="50%" stopColor="#ffffff" stopOpacity="0.8" />
        <stop offset="100%" stopColor="#39ff14" stopOpacity="0" />
      </linearGradient>
      <filter id="hyper_glow" x="-50%" y="-50%" width="200%" height="200%">
    ...
    <g className="animate-spin-slow" style={{ transformOrigin: '50px 50px' }}>
      <circle cx="50" cy="50" r="42" stroke="#0ea5e9" strokeWidth="0.5" strokeDasharray="4 8" opacity="0.4" />
      <circle cx="50" cy="50" r="38" stroke="#39ff14" strokeWidth="0.3" strokeDasharray="1 10" opacity="0.3" />
    </g>

    <g filter="url(#hyper_glow)">
      <path d="M50 25 C 65 15, 85 25, 85 45" stroke="url(#wing_grad)" strokeWidth="2" strokeLinecap="round" opacity="0.8" />
      <path d="M50 25 C 35 15, 15 25, 15 45" stroke="url(#wing_grad)" strokeWidth="2" strokeLinecap="round" opacity="0.8" />
    </g>

    <rect x="49" y="20" width="2" height="65" rx="1" fill="url(#caduceus_staff_grad)" filter="url(#hyper_glow)" />

    <g filter="url(#hyper_glow)">
      <path d="M50 80 Q 65 70, 50 60 Q 35 50, 50 40 Q 65 30, 50 22" stroke="#39ff14" strokeWidth="1.5" fill="none" strokeLinecap="round" className="animate-pulse" />
      <path d="M50 80 Q 35 70, 50 60 Q 65 50, 50 40 Q 35 30, 50 22" stroke="#0ea5e9" strokeWidth="1.5" fill="none" strokeLinecap="round" className="animate-pulse" />
    </g>

    <circle cx="50" cy="22" r="5" fill="white" filter="url(#hyper_glow)" className="animate-pulse" />
  </svg>
);
...
export const WavesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M2 6c.6.5 1.2 1 2.5 1 1.3 0 2.5-1 3.8-1 1.3 0 2.5 1 3.8 1 1.3 0 2.5-1 3.8-1" />
    <path d="M2 12c.6.5 1.2 1 2.5 1 1.3 0 2.5-1 3.8-1 1.3 0 2.5-1 3.8-1" />
    <path d="M2 18c.6.5 1.2 1 2.5 1 1.3 0 2.5-1 3.8-1 1.3 0 2.5-1 3.8-1" />
  </svg>
);
...
export const VisionHeadsetIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M2 17a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z" />
    <path d="M9 14a2 2 0 1 1 0-4 2 2 0 0 1 0 4Z" />
    <path d="M15 14a2 2 0 1 1 0-4 2 2 0 0 1 0 4Z" />
  </svg>
);
